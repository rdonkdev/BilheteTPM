        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($customer_added)
                {
                    ...
                    <strong>Successful!</strong> Cliente adicionado
                    ...
                    <strong>Error!</strong> Cliente ja existe
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $id == $id_if_customer_exists)
                {
                    ...
                    if(!$rowsAffected)
                    {
                        $messageInfo = "Nenhuma edição administrada!";
                    }
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Dados do cliente editados";
                    }
                    else{
                        // Show error alert
