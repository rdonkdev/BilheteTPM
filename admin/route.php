        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($route_added)
                {
                    ...
                    <strong>Successful!</strong> Rota adicionada
                    ...
                    <strong>Error!</strong> Rota já existe
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                else 
                {
                    ...
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Os detalhes da rota já existem
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Nenhuma Registrada!!</h1>
                        <p class="fw-light">Seja a primeira pessoa a adicionar um!</p>
                        <hr>
                        <div id="addRouteAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Adicionar <i class="fas fa-plus"></i></button> adicionar rota!
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <section id="route">
                    <div id="head">
                        <h4>Estado da rota</h4>
                    </div>
                    <div id="route-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Adicionar detalhes da rota <i class="fas fa-plus"></i></button>
                        </div>
                        <table class="table table-hover table-bordered">
                            <thead>
                                <th>ID</th>
                                <th>Rota</th>
                                <th>MAricula do autocarro</th>
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Adicionar rota</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">Rota</label>
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">Matricula do autocarro</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">Custo</label>
                                <input type="number" class="form-control" id="stepCost" name="stepCost" required>
                            </div>
                            <div class="mb-3">
                                <label for="date" class="form-label">Data de partida</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">Horario de partida</label>
