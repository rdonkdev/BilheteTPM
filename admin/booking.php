        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($booking_added)
                {
                    ...
                    <strong>Successful!</strong> Reserva adicionada
                    ...
                    <strong>Error!</strong> Reserva já existe
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    if(!$rowsAffected)
                    {
                        $messageInfo = "Nenhuma edição feita!";
                    }
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Detalhes do cliente atualizadas";
                    }
                    else{
                        // Show error alert
                    ...
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Cliente já existe!
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            ...
            if(isset($_POST["delete"]))
            {
                ...
                if(!$rowsAffected)
                {
                    $messageInfo = "O registro não existe";
                }

                elseif($deleteResult)
                {   
                    $messageStatus = "success";
                    $messageInfo = "Reserva cancelada";
                    $messageHeading = "Successfull!";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Não existe nenhuma marcação!!</h1>
                        <p class="fw-light">Seja a primeira pessoa a adicionar um!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Click on <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Adicionar <i class="fas fa-plus"></i></button> adicionar reserva!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Adicionar reserva<i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Fazer marcação</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">ID do cliente</label>
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">Nome do cliente</label>
                                <input type="text" class="form-control" id="cname" name="cname" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="cphone" class="form-label">Contacto do cliente</label>
                                <input type="tel" class="form-control" id="cphone" name="cphone" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="routeSearch" class="form-label">Rota</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="sourceSearch" class="form-label">Partida</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">Numero do acento</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    Selecione na figura acima, Máximo 1 assento.
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">Valor total</label>
