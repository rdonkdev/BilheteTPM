        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    ...
                    <p>
                        <em><b>Reservado em:</b> <br><?php echo $booked_timing; ?></em>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="text-center">
                    <h4><b>Codigo PNR :</b> <?php echo $pnr; ?></h5>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nome:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Rota:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Matricula de autocarro:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Acento numero:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Data da partida:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Horario da partida:</b></em></h4></td>
