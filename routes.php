...
<head>
    ...
    <title>Página de Pesquisa de Rotas</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav id="navbar">
            <div>
                ...
                <a href="#" class="nav-item">Galleria</a>
            </div>
            <ul>
    ...
    <main id="container">
        <section id="searched-route">
            <ul>
                <li class="searched-route-item" id="">Resultados totais : <span id="result-num">
                    <?php 
                        echo $count;
                    ?>
                </span></li>
            ...
            {?>
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Nenhuma rota encontrada!!</h1>
                        <p class="fw-light">
                        Atualmente não há serviços para a rota especificada
                        </p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                        Em breve disponibilizaremos esta rota para atendimento
                        </div>
                    </div>
                </div>
            <?php }
